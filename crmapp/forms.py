...
class AddRecordForm(forms.ModelForm):
    ...
    email      = forms.CharField(required=True,widget=forms.widgets.TextInput(attrs={'placeholder':'Email ID','class':'form-control'}),label="",max_length=50)
    ...
    address    = forms.CharField(required=True,widget=forms.widgets.TextInput(attrs={'placeholder':'Address','class':'form-control'}),label="",max_length=250)
